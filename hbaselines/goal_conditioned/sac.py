...
class GoalConditionedPolicy(BaseGoalConditionedPolicy):
    ...
    def __init__(self,
        ...
        super(GoalConditionedPolicy, self).__init__(
            ...
            use_sample_not_mean=use_sample_not_mean,
            max_rollout_using_model=max_rollout_using_model,
            max_rollout_when_training=max_rollout_when_training,
            worker_dynamics_bptt_lr=worker_dynamics_bptt_lr,
            worker_model_bptt_lr=worker_model_bptt_lr,
            add_final_q_value=add_final_q_value,
